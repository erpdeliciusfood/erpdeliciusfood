 ...
 * Do not modify this file directly. Instead, re-run the Supabase CLI to update it.
 * To make it more modular internally, definitions for Tables, Views, Functions, and Enums are extracted into separate types.
 */
