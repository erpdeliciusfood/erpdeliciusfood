...
import SalesProfitabilityReport from "@/components/reports/SalesProfitabilityReport"; // New import
      ...
      <div className="grid grid-cols-1 gap-8 mb-8">
        {dateRange.from && dateRange.to ? (
          <>
            ...
            <SalesProfitabilityReport startDate={dateRange.from} endDate={dateRange.to} /> {/* New component */}
