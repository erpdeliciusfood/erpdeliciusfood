  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <p className="mt-4 text-lg text-gray-700 dark:text-gray-300">Cargando pedidos...</p>
      </div>
    );
  }
  ...
  if (isError) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 text-red-600 dark:text-red-400">
        ...
        <p className="text-xl">No se pudieron cargar los pedidos: {error?.message}</p>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto p-4 md:p-8 lg:p-12 min-h-screen flex flex-col">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-4xl font-extrabold text-gray-900 dark:text-gray-100">Gestión de Pedidos</h1>
      ...
      <div className="flex-grow">
        {orders && orders.length > 0 ? (
          <OrderList orders={orders} onEdit={handleEditClick} />
        ) : (
          <div className="text-center py-10 text-gray-600 dark:text-gray-400">
            <p className="text-xl mb-4">No hay pedidos registrados. ¡Crea el primero!</p>
            <Button
              onClick={handleAddClick}
