...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-primary dark:bg-primary-foreground text-primary-foreground dark:text-primary p-5 shadow-md border-b border-primary-foreground/10 dark:border-primary/10">
      <div className="container mx-auto flex justify-between items-center">
        {/* Logo and Home Button */}
        <Link to="/" className="flex items-center group">
          <img src="/logo-erp.png" alt="App Logo" className="h-12 sm:h-14 w-auto mr-3 transition-transform duration-200 group-hover:scale-105" />
        </Link>
        ...
        <nav className="hidden md:flex items-center space-x-4 lg:space-x-6">
          {location.pathname !== "/" && (
            <Button
              ...
              className="text-primary-foreground dark:text-primary hover:bg-primary-foreground/20 dark:hover:bg-primary/20 px-5 py-2.5 text-lg h-11"
            >
          ...
          <Button
            ...
            className="text-primary-foreground dark:text-primary hover:bg-red-500/20 dark:hover:bg-red-500/20 px-5 py-2.5 text-lg h-11"
          >
        ...
        <div className="md:hidden flex items-center space-x-2">
          ...
          <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
            ...
            <SheetContent side="right" className="w-[280px] sm:w-[320px] p-6 flex flex-col bg-sidebar dark:bg-sidebar-primary text-sidebar-foreground dark:text-sidebar-primary-foreground">
              ...
              <div className="flex flex-col space-y-3 flex-grow">
                {location.pathname !== "/" && (
                  <Button
                    ...
                    className="justify-start text-lg px-5 py-3.5 h-auto w-full text-sidebar-foreground dark:text-sidebar-primary-foreground hover:bg-sidebar-accent dark:hover:bg-sidebar-accent-foreground"
                  >
                ...
                <Button
                  ...
                  className="justify-start text-lg px-5 py-3.5 h-auto w-full text-red-500 dark:text-red-400 hover:bg-red-500/20 dark:hover:bg-red-500/20"
                >
