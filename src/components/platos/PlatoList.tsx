...
const PlatoList: React.FC<PlatoListProps> = ({ platos, onEdit }) => {
  ...
  if (platos.length === 0) {
    return (
      <div className="text-center py-10 text-gray-600 dark:text-gray-400">
        ...
        <p className="text-xl">No hay platos registrados.</p>
      </div>
    );
  }
      ...
      <Table className="w-full">
        <TableHeader className="bg-gray-50 dark:bg-gray-700">
          <TableRow>
            ...
            {/* Removed Precio de Venta column */}
