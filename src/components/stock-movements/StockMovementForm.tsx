...
const formSchema = z.object({
  ...
  movement_type: z.enum(["purchase_in", "reception_in", "adjustment_in", "adjustment_out"], {
          ...
          render={({ field }) => (
            <FormItem>
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="purchase_in">Entrada por Compra (Almacén)</SelectItem>
                  <SelectItem value="reception_in">Recepción por Empresa</SelectItem>
