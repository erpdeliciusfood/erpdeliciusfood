      ...
      <Table className="w-full">
        <TableHeader className="bg-gray-50 dark:bg-gray-700">
          <TableRow>
            ...
            <TableHead className="text-left text-lg font-semibold text-gray-700 dark:text-gray-200 py-4 px-6">Menú Servido</TableHead> {/* Updated header */}
          ...
          {reports.map((report) => (
            <TableRow key={report.id} className="border-b last:border-b-0 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150 ease-in-out">
              ...
              <TableCell className="text-base text-gray-700 dark:text-gray-300 py-3 px-6">
                {report.menus?.title || "N/A"} {/* Corrected access */}
              </TableCell>
                  ...
                  <AlertDialogContent className="p-6">
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription className="text-base text-gray-700 dark:text-gray-300">
                        Esta acción no se puede deshacer. Esto eliminará permanentemente el reporte de servicio del {format(new Date(report.report_date), "PPP", { locale: es })} para {report.menus?.title || "N/A"} de nuestros servidores. {/* Corrected access */}
